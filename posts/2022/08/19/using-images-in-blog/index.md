---
categories: [devops]
date: 2022-08-19 00:00:00 +0000 UTC
lastmod: 2022-08-19 00:00:00 +0000 UTC
publishdate: 2022-08-19 00:00:00 +0000 UTC
...
![my-typora-license](../../../images/using-images-in-blog-01.webp)
...
- 上传图片，支持图床服务。可以将图片上传到指定的图床，前提是需要先安装一个客户端，这里我使用的是 PicGo。然后，PicGo 支持常见的一些图床服务。
  ...
  ![picgo-setting-image-server](../../../images/using-images-in-blog-02.webp)
...
![typora-setting-image](../../../images/using-images-in-blog-03.webp)
...
反过来，查询 https://cdn.jsdelivr.net/gh/chensoul/blog.chensoul.cc/images/ 下的图片地址替换 `/img`

```bash
grep -lr --null '](https://cdn.jsdelivr.net/gh/chensoul/blog.chensoul.cc/images/' | xargs -0 sed -i '' 's/](https:\/\/cdn.jsdelivr.net\/gh\/chensoul\/blog.chensoul.cc\/static\/img\/](\/img\/g'
```
