...
services:
  umami:
    ...
    ports:
      - "3003:3000"
    environment:
      DATABASE_URL: postgresql://umami:vps@027!@postgres:5432/umami
...
services:
  memos:
    ...
    environment:
      ...
      - MEMOS_DSN=postgres://memos:vps@027!@postgres:5432/memos?sslmode=disable
    volumes:
      - ~/.memos/:/var/opt/memos
    ports:
      - '5230:5230'
...
services:
  planka:
    ...
    environment:
      ...
      - DATABASE_URL=postgresql://planka:vps@027!@postgres:5432/planka
...
services:
  blinko:
    ...
    environment:
      ...
      DATABASE_URL: postgresql://blinko:vps@027!@postgres:5432/blinko
    restart: always
    ports:
      - "1111:1111"
    healthcheck:
...
docker exec -it postgres psql -U postgres -d umami -f /tmp/postgres_memos_20251111_12.sql
```
backup_n8n.sh：
