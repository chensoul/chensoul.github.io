...
categories: ["devops"]
tags: [vps,memos,umami,docker,n8n,postgres]
---
...
2. 在 postgres 容器创建 umami 数据库和用户：
...
\i /database/postgres_memos_20241227.sql

psql -d umami -U umami
\i /database/postgres_umami_20241227.sql

psql -d n8n -U n8n
\i /database/postgres_n8n_20241227.sql
```
...
0 1 * * * /opt/scripts/backup_db.sh
0 1 * * * /opt/scripts/backup_n8n.sh
```
