...
date: 2023-08-16T14:00:00+08:00
...
- **Container engine**: t负责运行Container的守护进程。
...
Docker 镜像由一堆层组成，每个层代表 Dockerfile 中的一条指令。每一层都是底层变化的增量。当我们从注册中心拉取Docker镜像时，它是被分层拉取并缓存在主机中的。
