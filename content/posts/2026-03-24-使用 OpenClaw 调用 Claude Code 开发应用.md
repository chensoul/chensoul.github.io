...
![2026-03-24-create-app-with-claude-code-in-openclaw](/images/create-app-with-claude-code-in-openclaw/01.webp)

为 Claude Code 配置 spec-kit 工作流，然后让 Claude Code 使用 spec-kit 开发一个拟物风格的 Todo List 应用

![2026-03-24-create-app-with-claude-code-in-openclaw-02](/images/create-app-with-claude-code-in-openclaw/02.webp)
