...
![my-typora-license](/images/my-typora-license.png)
...
- 上传图片，支持图床服务。可以将图片上传到指定的图床，前提是需要先安装一个客户端，这里我使用的是 PicGo。然后，PicGo支持常见的一些图床服务。
  ...
  ![picgo-setting-image-server](/images/picgo-setting-image-server.png)
...
![typora-setting-image](/images/typora-setting-image.png)
