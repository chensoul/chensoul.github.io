...
![oauth2-with-spring-part-4-02](oauth2-with-spring-part-4-02.webp)
...
![oauth2-with-spring-part-4-02](oauth2-with-spring-part-4-03.webp)

图 2

它将带我们进入以下页面。

![img](oauth2-with-spring-part-4-04.webp)

图 3

从这里，我们可以创建新的凭证 (3.1)。由于我们已经创建了凭证 (3.2)，我们可以编辑它 (3.3) 以查看我们如何配置它。

![img](oauth2-with-spring-part-4-05.webp)
...
![img](oauth2-with-spring-part-4-06.webp)

图 5

我已经创建了同意屏幕，所以让我们通过编辑应用程序看看我做了什么（5.2）

![img](oauth2-with-spring-part-4-07.webp)

图 6

此屏幕已在屏幕右侧详细记录（6.1）。遵循这些准则并保存以继续执行步骤 2：范围（6.2）

![img](oauth2-with-spring-part-4-08.webp)
...
![img](oauth2-with-spring-part-4-09.webp)
...
![img](oauth2-with-spring-part-4-10.webp)
