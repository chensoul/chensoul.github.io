...
![Maven Project Java](shared/spring_initializr.webp)
...
![Postman Body](spring-security-with-jwt/01.webp)

在这里，我们发出了第一个获取令牌的请求，正如我们所看到的，在提供正确的用户名/密码组合后，我们将取回令牌。

现在，在标头中使用该标记，让我们调用 /hello 端点。

![Postman Authorization Body](spring-security-with-jwt/02.webp)
