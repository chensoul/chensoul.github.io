...
date: 2026-03-31 17:44:00+08:00
draft: true
...
| 方法 | 优点 | 缺点 |
|------|------|------|
| WWW-Authenticate | 简单 | 无法控制生命周期 |
| Session-Cookie | 细粒度控制 | 仅浏览器友好 |
| Token | 兼容性好 | 加解密耗时 |
| JWT | 无状态、可验证 | Token 较大 |
| SSO | 一次登录多处使用 | 需要中央认证服务 |
| OAuth 2.0 | 授权第三方访问 | 流程复杂 |

**在线票务系统挑战**：
- 高并发、高 QPS
- 机器人攻击
- 解决方案：读写分离、内存缓存、反机器人、多数据中心

**去中心化社交网络**：
- Twitter：中心化，公司所有
- Mastodon：去中心化，志愿者运营，自托管实例

理解这些概念对设计安全系统和理解社交网络架构至关重要。
