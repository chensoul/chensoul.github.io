...
description: "Spring Security 为 Java 应用程序提供了一套全面的安全功能，涵盖身份验证、授权、会话管理以及针对CSRF（跨站点请求伪造） 等常见安全威胁的防护。Spring Security ..."
---
...
![设置](spring-security-jwt-guard/01.webp)
...
![设置](spring-security-jwt-guard/02.webp)
...
![设置](spring-security-jwt-guard/03.webp)
...
![设置](spring-security-jwt-guard/04.webp)
...
![设置](spring-security-jwt-guard/05.webp)
...
![设置](spring-security-jwt-guard/06.webp)
...
![设置](spring-security-jwt-guard/07.webp)
...
![设置](spring-security-jwt-guard/08.webp)
...
![设置](spring-security-jwt-guard/09.webp)
...
![设置](spring-security-jwt-guard/10.webp)
...
![设置](spring-security-jwt-guard/11.webp)

由于我们只有一个安全方案，因此我们将 JWT 令牌添加到`Authorize`swagger 页面顶部的按钮中：

![设置](spring-security-jwt-guard/12.webp)

设置了承载令牌后，让我们尝试访问`/library/books/all`端点：

![设置](spring-security-jwt-guard/13.webp)
