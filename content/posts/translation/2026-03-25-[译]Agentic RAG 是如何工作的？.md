...
tags: [ "agentic-rag", "retrieval-augmented-generation", "llm", "rag", "ai-agents" ]
description: "解释 Agentic RAG 如何把一次性检索流程变成带反馈的控制循环，并分析它相对标准 RAG 的优势与代价。"
...
- `01`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/01.png`；落盘文件名：`01.png`；alt / 图注：Agentic RAG 总览示意图
- `02`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/02.png`；落盘文件名：`02.png`；alt / 图注：标准 RAG 流程示意图
- `03`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/03.png`；落盘文件名：`03.png`；alt / 图注：Embedding 可视化示意图
- `04`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/04.png`；落盘文件名：`04.png`；alt / 图注：典型查询流示意图
- `05`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/05.png`；落盘文件名：`05.png`；alt / 图注：标准 RAG 局限性示意图
- `06`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/06.png`；落盘文件名：`06.png`；alt / 图注：Agentic RAG 控制循环示意图
- `07`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/07.png`；落盘文件名：`07.png`；alt / 图注：Agentic RAG 高层架构示意图
- `08`：原图 URL：`https://cos.chensoul.cc/images/how-agentic-rag-works/08.png`；落盘文件名：`08.png`；alt / 图注：ReAct / 多步推理与行动示意图
...
<!--
按配图清单将图片放入 public/images/how-agentic-rag-works/，文件名与正文 ![](NN.png) 一致。
可选：对 raster 运行 convert-to-webp；勿转 svg/ico。
git add 文章与 public/images/how-agentic-rag-works 后提交；如需上线，再同步 public/images 到 R2。
-->

建议保存路径：content/posts/translation/2026-03-25-[译]Agentic RAG 是如何工作的.md
