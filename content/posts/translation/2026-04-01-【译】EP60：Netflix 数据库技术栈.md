...
| 类型 | 数据库 | 用途 |
|------|--------|------|
| 关系型 | MySQL、CockroachDB | 计费、订阅、全球交易 |
| 列式 | Redshift、Druid | 分析、可视化 |
| 键值 | EVCache (Memcached) | 缓存、推荐 |
| 宽列 | Cassandra | 用户数据、观看历史 |
| 时间序列 | Atlas | 指标存储 |
| 非结构化 | S3、Iceberg | 图像/视频/日志 |

**10 个主导算法**：
排序、傅里叶变换、Dijkstra、RSA、SHA、整数分解、链接分析、PID、压缩、随机数
