...
date: 2026-04-01 09:22:00+08:00
draft: true
...
这篇文章介绍了 Meta 的 DrP（Debugging Platform）平台，核心是将调试知识工程化：

**问题背景**：
- 知识被困在人脑中（最佳调试员离职=知识丢失）
- 系统变化太快，文档跟不上
- 临时脚本无法跨服务边界

**DrP 解决方案**：
- 分析器（analyzer）= 程序化调查工作流
- 经过代码审查、CI/CD、测试
- 跨服务边界链接分析器
- 集成到警报生命周期
...
**关键洞察**：
- 调试知识应该被编码为可测试、可组合的软件
- 但需要保持人类在循环中（不自动修复）
- 用可管理的工程工作交换不可预测的值班劳累

这对于大规模分布式系统的故障排查非常有借鉴意义。
