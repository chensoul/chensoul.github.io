...
categories: [ "techlog" ]
tags: [ 'spring-ai' ]
cover: /thumbs/chat.svg
description: "本文将教你如何使用 Spring AI 项目构建基于不同聊天模型的应用程序。Spring AI 聊天模型提供了简单易用的接口，方便我们与这些模型进行交互。本示例默认使用 OpenAI，并通过 Maven Profile 切换 Anthropic 与 Ollama，同时通过 Spring Profile 支持多种 OpenAI 兼容模型。 ..."
---
