...
categories: [ "techlog" ]
tags: ['spring-ai']
cover: /thumbs/picture.svg
description: "本文将教你如何使用 Spring AI 的多模态特性创建一个能够处理图像和文本的 Spring Boot 应用程序。多模态是指能够同时理解和处理来自不同来源的信息，包括文本、图像、音频和其他数据格式。我们将进行一些关于多模态和图像的简单实验。 ..."
---
