---
title: "Git Flow 分支模型与使用"
date: 2023-05-11 08:00:00+08:00
slug: "git-flow-model-and-usage"
categories: [ "tech" ]
tags: ['git']
description: "介绍 Git Flow 的分支模型、核心概念和典型使用方式，帮助理解团队协作中的版本管理与发布流程。"
---
...
![img](git-flow-model-and-usage/01.webp)
...
![img](git-flow-model-and-usage/02.webp)
...
1. 使用 git-flow-feature-start Hook
...
1. 使用 git-flow-feature-finish-message Filter
...
1. 使用 git-flow-hotfix-start Hook
...
1. 使用 git-flow-hotfix-finish Hook
...
![github flow](git-flow-model-and-usage/03.webp)
...
![github-flow-whole](git-flow-model-and-usage/04.webp)
...
![img](git-flow-model-and-usage/05.webp)
...
1. GitLab Flow 与 GitHub Flow 的比较：
