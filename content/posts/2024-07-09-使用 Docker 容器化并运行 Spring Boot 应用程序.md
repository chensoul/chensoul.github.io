...
![Java 连接调试器](docker-for-spring-boot/01.webp)
...
![调试菜单](docker-for-spring-boot/02.webp)

您现在应该可以在 Compose 应用程序的日志中看到该连接。

![撰写日志文件](docker-for-spring-boot/03.webp)
...
![调试器代码断点](docker-for-spring-boot/04.webp)
