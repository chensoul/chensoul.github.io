---
title: "[译]OAuth2.0服务器"
date: 2024-06-05T14:00:00+08:00
slug: oauth2-server
categories: ["Java"]
tags: [oauth2]
---
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/twitter_logged_out_auth_screen.png)Twitter 授权屏幕的未登录视图
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/okta_oauth-diagrams_20170622-04.png)登录与未登录的用户流程

如果授权服务器需要通过 SAML 或其他内部系统对用户进行身份验证，则用户流程将如下所示

![img](https://www.oauth.com/wp-content/uploads/2016/08/okta_oauth-diagrams_20170622-05.png)单独身份验证服务器的用户流程

在此流程中，用户登录后将被引导回授权服务器，在那里他们会看到授权请求，就像已经登录一样。

### 授权接口

![img](https://www.oauth.com/wp-content/uploads/2022/05/oauth_authorization_screen.png)OAuth 授权屏幕示例
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/dropbox.png)

Flickr 授权界面显示了用户登录时授予应用的三项权限，并清楚地显示了应用不会拥有的权限*。*显示这些权限的好处是，用户可以放心，他们授权的应用不会执行潜在的破坏性操作。

![img](https://www.oauth.com/wp-content/uploads/2016/08/flickr.png)

GitHub 在提供用户授予范围的详细信息方面做得非常出色。请求的每个范围在页面上都有一个部分，其中包含名称、图标、简短说明（突出显示这是只读还是读写）以及用于查看更详细说明的下拉菜单。

![img](https://www.oauth.com/wp-content/uploads/2016/08/github.png)

Google 为其所有服务（包括 Gmail API、Google Drive、Youtube 等）提供单一授权端点。其授权界面以列表形式显示每个范围，并包含一个“信息”图标，您可以单击该图标以获取有关特定范围的更多信息。

![img](https://www.oauth.com/wp-content/uploads/2016/08/google.png)

单击信息图标将显示一个覆盖层，详细描述此范围允许的内容。

![img](https://www.oauth.com/wp-content/uploads/2016/08/google-scope-popup.png)
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/benwerd-twitter-checkboxes.png)
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/facebook.png)

如果您点击“编辑您提供的信息”，您将进入一个界面，其中列出了应用程序请求的每个范围，您可以根据需要取消选中它们。在下面的屏幕截图中，我选择不允许应用程序查看我的好友列表。

![img](https://www.oauth.com/wp-content/uploads/2016/08/facebook-edit-scope.png)
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/fitbit-authorize.png)
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/google-authorization-list.png)您已授权访问您的 Google 帐户的应用程序列表

该列表显示申请图标、名称以及申请获准范围的摘要。单击其中一个可展开该部分以显示更多详细信息。

![img](https://www.oauth.com/wp-content/uploads/2016/08/google-authorization-details.png)有权访问您的 Google 帐户的某个应用程序的详细信息
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/twitter-authorization-list-1024x719.png)您已授权访问 Twitter 帐户的应用程序列表
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/github-authorization-list-1024x462.png)您已授权访问您的 GitHub 帐户的应用程序列表

GitHub 提供的列表包含应用程序上次使用情况的描述，以便让您了解如果应用程序在一段时间内未使用，是否可以安全地撤销其凭据。

单击某个应用程序可以提供有关该应用程序访问的更多详细信息。

![img](https://www.oauth.com/wp-content/uploads/2018/07/github-authorization-details.png)有权访问你的 GitHub 帐户的一个应用程序的详细信息
...
![img](https://www.oauth.com/wp-content/uploads/2016/08/google-apis.png)
...
![img](https://www.oauth.com/wp-content/uploads/2017/08/getting-device-code-1024x275.jpg)设备发出 API 请求以获取设备代码

接下来，我们看到设备会显示代码以及 URL。

![img](https://www.oauth.com/wp-content/uploads/2017/08/device-code-display-1024x275.jpg)设备显示设备代码和URL

登录您的 Google 帐户后，访问该网址将显示一个界面，提示您输入设备上显示的代码。

![img](https://www.oauth.com/wp-content/uploads/2017/08/google-1-enter-the-code.png)Google 提示用户输入代码

输入代码并单击“下一步”后，您将看到标准 OAuth 授权提示，其中描述了应用程序请求的范围，如下所示。

![img](https://www.oauth.com/wp-content/uploads/2017/08/google-2-scope.png)Google 显示应用程序请求的范围

一旦您允许请求，Google 就会显示一条消息，提示您返回到您的设备，如下所示。

![img](https://www.oauth.com/wp-content/uploads/2017/08/google-3-return-to-device.png)
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/indieauth-login-prompt-1024x436.png)
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/indieauth-authorization-prompt-aaronpk-1024x969.png)

![img](https://www.oauth.com/wp-content/uploads/2018/07/indieauth-authorization-prompt-wordpress.png)
...
![img](https://www.oauth.com/wp-content/uploads/2018/07/oauth-playground-1024x752.png)
...
![jwt.io](https://www.oauth.com/wp-content/uploads/2021/12/jwt-io-1024x792.png)jwt.io
