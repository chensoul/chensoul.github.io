...
| 文件/目录 | 说明 | chezmoi 命名 |
|----------|------|-------------|
| `~/.aliases` | Shell 别名和函数 | `dot_aliases` |
| `~/.myrc` | 个人自定义配置 | `private_dot_myrc` |
...
| `~/.config/fish/config.fish` | Fish Shell 配置 | `dot_config/fish/config.fish` |
...
├── dot_aliases                   # Shell 别名和函数
├── private_dot_myrc              # 个人配置（加密）
├── private_dot_zprofile          # 登录 Shell 环境变量（Homebrew 镜像源）
├── dot_config/
