...
```bash
# ~/.zshrc 中配置
source ~/github/dotfiles/dot_zsh_aliases
source ~/github/dotfiles/dot_zsh_functions
```

**别名文件 `dot_zsh_aliases`：**
- 基础别名：`ll`、`la`、`l`、`..`、`...` 等
- Git 别名：`g`、`gs`、`ga`、`gc`、`gco`、`gb`、`gl`、`gp`、`gpull`
- pnpm 别名：`p`、`pi`、`pd`、`pb`、`ps`、`pt`

**函数文件 `dot_zsh_functions`：**
...
| `~/.zshrc`                   | Zsh Shell 配置          | `private_dot_zshrc`                    |
| `~/.zsh_aliases`             | Zsh 别名                | `dot_zsh_aliases`                      |
| `~/.zsh_functions`           | Zsh 函数                | `dot_zsh_functions`                    |
