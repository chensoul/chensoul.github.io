...
```xml
		<organization>
        <name>ChenSoul™</name>
        <url>https://blog.chensoul.com/</url>
    </organization>
...
![daily-review-20231213-03](https://chensoul.oss-cn-hangzhou.aliyuncs.com/images/daily-review-20231213-03.png)
...
![daily-review-20231213-04](https://chensoul.oss-cn-hangzhou.aliyuncs.com/images/daily-review-20231213-04.png)
...
![daily-review-20231213-05](https://chensoul.oss-cn-hangzhou.aliyuncs.com/images/daily-review-20231213-05.png)
...
```bash
mvn clean source:jar javadoc:jar deploy -DskipTests -P release -DautoReleaseAfterClose=true
```
...
参考 [maven_release.yml](https://github.com/chensoul/chensoul-parent/blob/main/.github/workflows/maven_release.yml) 文件，需要自 GitHub Actions 的 Actions 页面配置以下 Secrets：
...
```bash
mvn -ntp -B -U clean deploy site scm-publish:publish-scm -P release -DautoReleaseAfterClose=true
```

> 注意：这里 scm-publish 是把生成的 site 站点发布到该仓库的 gp-pages 分支
