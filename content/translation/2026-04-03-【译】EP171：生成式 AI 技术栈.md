...
|------|------|
| 云托管 | AWS、GCP、Azure |
| 基础模型 | GPT、Claude、Llama |
| 框架 | LangChain、PyTorch |
| 数据库 | Pinecone、Weaviate |
| 微调 | Weights & Biases |
| 嵌入 | Cohere、Nomic |
| 合成数据 | Gretel、Tonic AI |

**学习资源**：
- 书籍：DDIA、System Design
- 博客：Netflix、Uber、Meta
- YouTube：MIT、Goto、ByteByteGo
- 白皮书：Facebook、Cassandra、DynamoDB
