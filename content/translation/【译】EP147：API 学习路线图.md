...
这篇文章涵盖了 API 学习、AI 应用、生产架构和认证的核心概念：

**API 学习路线图 10 个主题**：
| 主题 | 内容 |
|------|------|
| API 介绍 | 公共、私有、合作伙伴 API |
| API 术语 | HTTP、cookies、缓存 |
| API 风格 | REST、SOAP、GraphQL、gRPC |
| API 认证 | Basic、Token、JWT、OAuth |
| API 文档 | Swagger、Postman、Redoc |
| API 特性 | 分页、幂等性、版本控制 |
| API 性能 | 缓存、限流、负载均衡 |
| API 网关 | Amazon、Azure、Kong、Nginx |
| API 框架 | Node.js、Spring、FastAPI |
| API 集成 | 网关、事件驱动、webhook |

**30 个 AI 应用分类**：
| 类别 | 应用 |
|------|------|
| 通用 | Perplexity、Claude、ChatGPT |
| 编码 | Cursor、Copilot、Tabnine |
| 生产力 | Gamma、WisprFlow、Granola |
| 受众 | HeyGen、Persona、Captions |
| 创造力 | ElevenLabs、Midjourney、Suno |
| 学习 | NotebookLM、Rosebud、Ash |
