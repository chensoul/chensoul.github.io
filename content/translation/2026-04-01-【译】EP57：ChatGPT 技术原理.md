...
tags: [ "chatgpt", "llm", "design-patterns" ]
...
| 类型 | 模式数量 | 代表模式 |
|------|----------|----------|
| 创建型 | 4 | Abstract Factory、Builder、Singleton |
| 结构型 | 7 | Adapter、Decorator、Facade、Proxy |
| 行为型 | 7 | Observer、Command、Iterator、Mediator |
