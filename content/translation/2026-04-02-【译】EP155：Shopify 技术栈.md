...
tags: [ "shopify", "tech-stack", "ecommerce" ]
...
这篇文章涵盖了 SSO、Java 虚拟线程、Redis、Shopify 技术栈和招聘的核心概念：

**SSO 工作流程**：
| 步骤 | 操作 |
|------|------|
| 1 | 用户访问应用，重定向到 SSO |
| 2-3 | SSO 验证凭据，创建会话和令牌 |
| 4-7 | 应用验证令牌，返回资源 |
| 8-14 | 访问其他应用，无需重新登录 |
...
|------|------|
| 轻量级 | 百万线程高效 |
| 不映射 OS 线程 | 调度到少量 Platform Threads |
| I/O 绑定优势 | 阻塞操作不阻塞 OS 线程 |
| 释放线程 | Platform 线程处理其他虚拟线程 |
...
| 类别 | 技术 |
|------|------|
| 语言 | Ruby、Typescript、Lua、React |
| 后端 | Rails、Nginx、OpenResty、GraphQL |
| 数据 | MySQL、Redis、Memcached |
| DevOps | GitHub、Docker、K8s、BuildKite |
