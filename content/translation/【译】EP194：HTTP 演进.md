...
这篇文章涵盖了 HTTP 演进和网络基础：

**HTTP 版本**：
| 版本 | 特点 | 改进 |
|------|------|------|
| HTTP/0.9 | 简单 HTML | 无 |
| HTTP/1.0 | 头部、状态码 | 丰富交互 |
| HTTP/1.1 | 持久连接 | 更高效 |
| HTTP/2 | 多路复用 | 性能提升 |
| HTTP/3 | QUIC over UDP | 更低延迟 |
...
- Concurrency：并发数
- Response Time：响应时间
- 关系：QPS = Concurrency ÷ RT

**网络设备**：
- Hub：Layer 1，广播
- Switch：Layer 2，MAC 地址
- Router：Layer 3，IP 路由
