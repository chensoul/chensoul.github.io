...
这篇文章涵盖了 REST API、AWS 服务和 LLM 术语的核心概念：
...
| 计算 | 5 | EC2、Lambda、EKS |
| 存储 | 5 | S3、EBS、Glacier |
| 数据库 | 7 | RDS、DynamoDB、Aurora |
| 网络安全 | 5 | VPC、CloudFront、WAF |
| AI/ML | 4 | SageMaker、Rekognition |
| 监控 DevOps | 4 | CloudWatch、CodePipeline |
