...
description: "内容 ..."
canonicalURL: "https://www.tutorialspoint.com/spring_security/spring_security_form_login_remember_me_and_logout.htm"
---
...
![Spring Initializr](shared/spring_initializr.webp)
...
![Sign In](spring-security-form-login-remember-me-and-logout/01.webp)

### 登录页面

现在，如果我们提供在 WebSecurity 配置文件中配置的用户信息，我们将能够登录。此外，如果我们勾选“记住我”复选框，我们将能够在我们的 WebSecurity 配置文件中看到“记住我”cookie 浏览器的开发者工具部分。

![Console Application](spring-security-form-login-remember-me-and-logout/02.webp)
![Console Network](spring-security-form-login-remember-me-and-logout/03.webp)
