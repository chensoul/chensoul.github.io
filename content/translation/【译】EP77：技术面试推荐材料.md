...
date: 2026-04-01 07:51:00+08:00
draft: true
...
| 类型 | 推荐资源 |
|------|----------|
| 编码 | Leetcode、Cracking the Coding Interview、Neetcode |
| 系统设计 | System Design Interview 1&2、Grokking、DDIA |
| 行为 | Tech Interview Handbook、STAR method |
| OOD | Interviewready、Head First Design Patterns |
| 模拟 | Interviewingio、Pramp、Meetapro |

**云监控 9 大方面**：
数据收集、存储、分析、警报、可视化、报告合规、自动化、集成、反馈循环

**5 种缓存策略**：
- 读：Cache Aside、Read Through
- 写：Write Around、Write Back、Write Through

**Uber 技术栈亮点**：
- Web：Fusion.js、visualization.js
- 移动：RIB + VIPER（Swift/Java）
- 服务网格：Uber Gateway（NGINX + gRPC + QUIC）
- 配置：Flipr/UCDP、H3
- 数据库：DocStore（MySQL/PostgreSQL/RocksDB）
- 大数据：Hadoop、Hudi、Parquet、Pinot、AresDB
- DevOps：Monorepo、Spinnaker、uMetric、M3

**消息队列 8 大特性**：
速度、可扩展性、可靠性、耐久性、易用性、生态系统、集成、协议支持

理解这些面试准备和工程实践对职业发展至关重要。
