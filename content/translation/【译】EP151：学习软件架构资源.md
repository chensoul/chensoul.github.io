...
tags: [ "learning", "software-architecture", "resources" ]
...
这篇文章涵盖了学习资源、API 风格和 AWS 服务的核心概念：

**24 个学习资源分类**：
| 类型 | 资源 |
|------|------|
| 书籍 | DDIA、Clean Architecture、System Design |
| 博客 | Netflix、Uber、Meta、Airbnb、ByteByteGo |
| YouTube | MIT Distributed Systems、Goto、ByteByteGo |
| 白皮书 | Facebook Memcache、Cassandra、DynamoDB |
| 职业书籍 | Pragmatic Programmer、Software Architect Elevator |
...
**Grok-3 关键事实**：
- 10 万 Nvidia H100 GPU
- 2 亿 GPU 小时训练
- DeepSearch、Think Mode、Big Brain Mode
- 多模态输入支持
...
- 不同 AWS 消息服务适合不同场景
- API 性能优化需要多策略
- Grok-3 是 xAI 的最新强大 AI 模型

理解这些概念对软件架构学习和系统设计至关重要。
