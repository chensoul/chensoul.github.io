...
date: 2026-04-01 07:30:00+08:00
draft: true
...
**Uber CI/CD 技术栈亮点**：
- Monorepo + Bazel
- 自研工具：Flipr、NullAway、Piranha、SLATE、Shadower、Ballast、uBuild、uMetric、Peloton、Crane
- 部署：Netflix Spinnaker
- 监控：自研 uMetric（基于 Cassandra）
