...
| 步骤 | 技能 | 关键工具/技术 |
|------|------|---------------|
| 1 | 协作工具 | Jira、Slack、Zoom |
| 2 | 编程语言 | Java、Python、Go |
| 3 | API 开发 | REST、GraphQL、gRPC |
| 4 | Web 服务器 | AWS、Kubernetes |
| 5 | 认证测试 | JWT、OAuth2、TDD |
| 6 | 数据库 | Postgres、MongoDB、Redis |
| 7 | CI/CD | GitHub Actions、Jenkins |
| 8 | DSA | Big O、排序、树、图 |
| 9 | 系统设计 | 缓存、CDN、微服务 |
| 10 | 设计模式 | 依赖注入、工厂、观察者 |
| 11 | AI 工具 | Copilot、ChatGPT |
...
- NoSQL：Cassandra、MongoDB、Redis、Couchbase
- 图：Neo4j
