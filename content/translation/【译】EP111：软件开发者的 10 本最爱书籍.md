...
| 类别 | 书籍 | 作者 |
|------|------|------|
| 通用建议 | The Pragmatic Programmer | Andrew Hunt |
| 通用建议 | Code Complete | Steve McConnell |
| 编码 | Clean Code | Robert C. Martin |
| 编码 | Refactoring | Martin Fowler |
| 软件架构 | Designing Data-Intensive Applications | Martin Kleppmann |
| 软件架构 | System Design Interview | Alex Xu |
| 设计模式 | Design Patterns | Eric Gamma |
| 设计模式 | Domain-Driven Design | Eric Evans |
| 数据结构和算法 | Introduction to Algorithms | Cormen 等 |
| 数据结构和算法 | Cracking the Coding Interview | Gayle Laakmann |

**25 篇经典论文**：
- Dynamo、GFS、BigTable、Spanner（分布式系统）
- MapReduce、Flink（数据处理）
