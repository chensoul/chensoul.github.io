...
date: 2026-03-31 16:23:00+08:00
draft: true
...
这是 ByteByteGo 的 EP208 期，内容比较杂，但都是系统设计中的基础话题：

**负载均衡器 vs API 网关**：
- 负载均衡器 = 流量分发器（ dumb but reliable）
- API 网关 = 智能守门人（认证、限流、聚合、转换）
- 生产环境通常两者一起用，不是二选一

**MCP**：
- Anthropic 推的 AI 工具集成标准
- 让 AI 模型能连接外部系统而不用写定制代码
- 类似"AI 的 USB 接口"
...
这期更像是一个快速复习，每个话题都可以单独深入。对于面试准备或者系统设计复习来说，这种形式挺高效的。
