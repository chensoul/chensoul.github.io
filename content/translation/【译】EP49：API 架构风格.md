...
| 风格 | 年份 | 用途 | 特点 |
|------|------|------|------|
| REST | 2000 | 前后端通信 | 最常用，符合 6 大约束 |
| GraphQL | 2015 | 复杂图状关系 | 一次调用获取多实体 |
| WebSocket | - | 实时通信 | 全双工，推送模式 |
| Webhook | - | 第三方异步调用 | 状态机一部分 |
| gRPC | 2016 | 微服务通信 | 高效编码/传输 |
| SOAP | - | 内部系统通信 | 仅 XML |
...
- 每个模式都有 View、Model 和翻译器
- 翻译器复杂度推动模式演进

理解这些 API 风格和架构模式对系统设计至关重要。
