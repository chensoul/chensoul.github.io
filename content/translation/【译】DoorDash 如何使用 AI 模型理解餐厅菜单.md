...
这篇文章介绍了 DoorDash 如何使用 AI 自动化菜单转录：
...
**解决方案**：
- **Guardrail 模型**：分类器预测转录是否足够准确
- **多视图特征**：图像质量、OCR 可靠性、LLM 输出质量
- **混合方法**：结合 OCR+LLM 和多模态 LLM

**关键洞察**：
- 简单模型（LightGBM）优于复杂深度学习
- 多模态 LLM 理解布局更好但更脆弱
- Guardrail 仲裁质量平衡自动化和准确性
- 混合设置利用两种方法的优势
