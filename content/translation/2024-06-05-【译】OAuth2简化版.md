...
![OAuth Authorization Prompt](oauth-2-simplified/01.webp)
...
![OAuth Authorization Prompt](oauth-2-simplified/01.webp)如果用户单击“允许”，则该服务会使用身份验证代码将用户重定向回您的网站
...
![Facebook Authorization Prompt](oauth-2-simplified/02.webp)
