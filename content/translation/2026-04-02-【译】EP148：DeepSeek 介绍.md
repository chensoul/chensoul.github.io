...
这篇文章涵盖了 DeepSeek、书籍推荐、AI 代理、Git、数据库性能和网络端口的核心概念：
...
| 类别 | 书籍 | 作者 |
|------|------|------|
| 通用 | The Pragmatic Programmer | Andrew Hunt |
| 通用 | Code Complete | Steve McConnell |
| 编码 | Clean Code | Robert C. Martin |
| 编码 | Refactoring | Martin Fowler |
| 架构 | Designing Data-Intensive Applications | Martin Kleppmann |
| 架构 | System Design Interview | Alex Xu |
| 设计模式 | Design Patterns | Eric Gamma |
| 设计模式 | Domain-Driven Design | Eric Evans |
| 算法 | Introduction to Algorithms | Cormen 等 |
| 算法 | Cracking the Coding Interview | Gayle Laakmann |
