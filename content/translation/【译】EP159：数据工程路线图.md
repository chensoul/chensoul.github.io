...
这篇文章涵盖了数据工程、进程线程、版本控制和 Transformers：
...
| 自动化 | Jenkins、Github Actions、Terraform |
| 前端/仪表板 | Jupyter、PowerBI、Tableau |
...
**AI 学习资源**：
- YouTube：Two Minute Papers、DeepLearning AI、Lex Fridman
- 博客：TowardsDataScience、OpenAI Blog、DeepMind
