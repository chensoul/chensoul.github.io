...
软件开发是一个充满想法和实验的领域。一个想法导致一个实验，实验又产生另一个想法，创新循环向前推进。
...
自 1995 年发布以来，Apache HTTP Server 一直是一个不知疲倦的开拓者。它在安全性和敏捷性方面足够多功能，被企业和初创公司采用。
...
然后，他们得到回答——"是的，但我们不能把你的机器运到生产。"

Docker 使其成为可能。

作为一个开源平台，Docker 允许开发人员以一致和便携的方式打包和部署应用。

特定于应用的包和所有环境依赖项都打包在 Docker 容器镜像中。然后可以将此镜像部署到任何需要的地方。

## 译者总结

这篇文章介绍了 15 个改变世界的开源项目（本文展示了前 5 个）：
...
- 发布时间：1995 年
- 影响：为大部分网站提供动力
- 启发了 Nginx、Lighttpd、Caddy 等

**3. Git**
- 创建者：Linus Torvalds（又是他！）
- 目的：管理 Linux 内核源代码
- 影响：版本控制标准，催生了 GitHub、Bitbucket

**4. Node.js**
- 发布时间：2009 年
- 影响：将 JavaScript 带到后端
- 实现前后端使用相同语言
...
这些项目不仅改变了开发人员的工作方式，也改变了整个软件行业的运作模式。
