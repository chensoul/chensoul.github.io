...
|------|------|
| 编程语言 | 掌握 1-2 门语言 |
| 工具 | GitHub、Jenkins、Jira |
| 设计原则 | OOPS、Clean Code、TDD |
| 架构原则 | 微服务、事件驱动等 |
| 平台知识 | 容器、云、CDN |
| 数据分析 | SQL、NoSQL、Kafka |
| 网络安全 | DNS、TCP、TLS、OAuth |
| 支持技能 | 决策、沟通、领导力 |
...
|------|----------|
| 时间序列 | Timescale |
| 机器学习 | pgVector、PostgresML |
| OLAP | Hydra、Citus |
| 地理空间 | PostGIS |
| 搜索 | pgroonga、ParadeDB |
| 联邦查询 | 多数据源集成 |
| 图数据库 | Apache AGE、EdgeDB |
