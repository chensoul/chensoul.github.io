...
如果你想了解 Xcode command line tools 包含多少可用的命令，可以到 `/Library/Developer/CommandLineTools/usr/bin/` 查看：
...
也可以在 [gitignore.io](https://www.gitignore.io/?templates=macos) 生成 .gitignore。

配置Git仓库忽略 ~/.gitignore 中的文件：
...
==> Formulae
apm-bash-completion          docker-compose-completion    maven-completion             sonar-completion
...
docker-completion            launchctl-completion         rustc-completion             zsh-completions ✔
```
...
- [Airmail](http://airmailapp.com/)：轻量邮件客户端
- [Alfred](http://www.alfredapp.com/)：屏保程序
- [AppCleaner](http://www.freemacsoft.net/appcleaner/)：卸载软件
- [Unarchiver](http://wakaba.c3.cx/s/apps/unarchiver.html)：解压缩软件
- [Timing](http://timingapp.com/)：计时软件
